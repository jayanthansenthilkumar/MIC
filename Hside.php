...
<aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar">
                ...
                <span class="hide-menu">&nbsp;Dashboard</span></a></li>
						...
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="hview" aria-expanded="false"><img src="images/icon/staff.png" class="custom-svg-icon" alt="Dashboard Icon"><span class="hide-menu">&nbsp;Faculty</span></a></li>
