                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi-person"></i><b> Add New Faculty</b></span></a> </li>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3" id="pstatus">
                                                            ...
                                                            <select class="form-control" name="dept" id="pstatuss">
                                                                ...
                                                                <option value="Electronics Engineering (VLSI Design)">
                                                                ...
                                                                <option value="Mechanical Engineering">Mechanical
                                                                    Engineering</option>
                                                                <option value="Freshman Engineering">Freshman
                                                                    Engineering</option>
                                                                <option value="Master of Business Administration">Master
                                                                    of Business Administration</option>
                                                                <option value="Master of Computer Applications">Master
                                                                    of Computer Applications</option>
                                                            </select>
                                                        </div>

                                                        <div class="mb-3" id="pstatus">
                                                            <label for="">Deputation Department *</label>
                                                            <select class="form-control" name="ddept" id="pstatuss">
                                                                <option value="">Select department</option>
                                                                <option
                                                                    value="Artificial Intelligence and Data Science">
                                                                    Artificial Intelligence and Data Science</option>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="file"
                                                                    ...
                                                                    id="uploadFile4" onchange="return fileValidation4()"
                                                                    aria-describedby="inputGroupPrepend" required>
                                                                <label class="custom-file-label" for="customFile">Upload
                                                                    1st page as image</label>
                                                            </div>
                                    ...
                                    <!-- View Student Modal -->
                                    <div class="modal fade" id="studentViewModal3" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <img id="image2" src="" alt="Computer man" class="center"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form id="updatefaculty">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3" id="deptt">
                                                            <label for="">Deputation Department *</label>
                                                            <select class="form-control" name="ddept" id="ddept">
                                                                <option value="">Select department</option>
                                                                <option
                                                                    value="Artificial Intelligence and Data Science">
                                                                    Artificial Intelligence and Data Science</option>
                                                                    ...
                                                                    foreach ($query_run as $student) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                if ($status == 1): ?>
                                                                                    <button
                                                                                        class="btn btn-success btn-sm status-toggle"
                                                                                        data-id="<?= $student['id'] ?>"
                                                                            ...
                                                                            <td align="center" style="white-space: nowrap;">
                                                                                <button type="button" id="ledonof"
                                                                                    value="<?= $student['uid']; ?>"
                                                                                    class="btnimg5 btn-primary btn-sm"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#studentViewModal3">View</button>
                                                                                <button type="button"
                                                                                    value="<?= $student['uid']; ?>"
                                ...
                                <div class="modal fade" id="remarksModal" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Update Faculty Status</h5>
                                                ...
                                                <form id="statusUpdateForm">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="remarks"
                                                            id="status_remarks" rows="3" required
...
<div class="modal fade" id="studentViewModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="table-responsive">
    ...
    <script>
        ...
        // Add remarks for active and inactive
        ...
        $(document).on('submit', '#statusUpdateForm', function (e) {
            ...
            // Validate remarks
            var remarks = $('#status_remarks').val().trim();
            if (remarks === '') {
                alertify.error('Remarks are required');
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "fcode.php",
                data: $(this).serialize() + '&update_faculty_status=true',
                dataType: 'json',
                success: function (response) {
                    if (response.status == 200) {
                        ...
                        // Reload the table to reflect status change
                        $('#myTable2').load(location.href + " #myTable2");
                    } else {
