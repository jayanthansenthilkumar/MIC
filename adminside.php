    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                        href="javascript:void(0)" aria-expanded="false"><img src="images/icon/book1.png"
                            class="custom-svg-icon" alt="Dashboard Icon"><span class="hide-menu">&nbsp;HR Wallet</span></a>
                    <ul aria-expanded="false" class="collapse  first-level" style="background-color: #30302f ;">

                        <li class="sidebar-item"><a href="hrleave" class="sidebar-link"><img src="images/icon/basic.png"
                                    class="custom-svg-icon" alt="Dashboard Icon"><span class="hide-menu">&nbsp;My Wallet</span></a></li>
                        <li class="sidebar-item"><a href="hodleave" class="sidebar-link"><img src="images/icon/edit.png"
                                    class="custom-svg-icon" alt="Dashboard Icon"><span class="hide-menu"> &nbsp;Faculty Wallet</span></a></li>
                    </ul>
                </li>
...
<!-- 
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="hrleave"
                        aria-expanded="false"><img src="images/icon/student.png" class="custom-svg-icon"
                            alt="Dashboard Icon"><span class="hide-menu">&nbsp;WalletHR</span></a></li> -->
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="hview"
                        aria-expanded="false"><img src="images/icon/staff.png" class="custom-svg-icon"
                            alt="Dashboard Icon"><span class="hide-menu">&nbsp;Faculty</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="csview"
                        aria-expanded="false"><img src="images/icon/staff.png" class="custom-svg-icon"
                            alt="Dashboard Icon"><span class="hide-menu">&nbsp;Mentor - Mentee</span></a></li>

                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ffeedback"
                        aria-expanded="false"><img src="images/icon/feedback1.png" class="custom-svg-icon"
                            alt="Dashboard Icon"><span class="hide-menu">&nbsp;Feedback Corner</span></a></li>
