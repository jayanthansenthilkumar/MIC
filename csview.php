...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Mentees Profile Information</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Mentees Profile Information
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi-person"></i><b> View Students</b></span></a> </li>

                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#stdsum"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi bi-book"></i><b> Students Summary</b></span></a> </li>

                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi bi-book"></i><b> Student Details</b></span></a> </li>

                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#couns"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi bi-book"></i><b> Reset</b></span></a> </li>

                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#smedi"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi bi-book"></i><b> HackerRank</b></span></a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#regc"
                                        role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                                class="bi bi-book"></i><b> Reg Num Change</b></span></a> </li>
                                    ...
                                    <form id="aprofile" class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-3" id="deptt">
                                            ...
                                            <select class="form-control" name="dept" id="dept">
                                                ...
                                                <option value="Computer Science and Business Systems">Computer Science
                                                ...
                                                <option value="Electronics Engineering (VLSI Design)">Electronics
                                                    Engineering (VLSI Design)</option>
                                                <option value="Electronics and Communication Engineering">Electronics
                                                    and Communication Engineering</option>
                                                <option value="Information Technology">Information Technology</option>
                                                <option value="Mechanical Engineering">Mechanical Engineering</option>
                                                <option value="Freshman Engineering">Freshman Engineering</option>
                                                <option value="Master of Business Administration">Master of Business
                                                    Administration</option>
                                                <option value="Master of Computer Applications">Master of Computer
                                                    Applications</option>
                                            </select>
                                        </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php if ($student['status'] == 1): ?>
                                                                                    <button type="submit"
                                                                                        value="<?= $student['sid']; ?>"
                                                                                        class="resetBtn btn btn-info btn-md m-r-5">↺</button>

                                                                                <?php endif; ?>
                                                                                <button type="submit"
                                                                                    value="<?= $student['sid']; ?>"
                                                                                    class="presetBtn btn btn-dark btn-md m-r-5"
                                                                                    style="background-color: #522D5E; color: white;">🔑</button>

                                                                                <button type="submit"
                                                                                    value="<?= $student['sid']; ?>"
                                                                                    class="pdeleteBtn btn btn-dark btn-md m-r-5"
                                        ...
                                        <table id="studentTable" class="table table-striped table-bordered"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><b>Name</b></th>
                                                    <th><b>C Score</b></th>
                                                    <th><b>Java Score</b></th>
                                                    <th><b>Python Score</b></th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
                                        </table>
        ...
        <!-- Include DataTables Buttons and JSZip for Excel export -->
