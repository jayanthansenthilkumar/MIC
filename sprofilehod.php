...
<div class="container-fluid">
   <div class="main-body">
      <div class="row gutters-sm">
                     ...
                     <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?= $student['prize'] ?></td>
                              <td align="center"><button type="button" id="ledonof" value="<?=$student['uid'];?>" class="btnimgpr btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#studentViewModal4">View</button></td>
                           </tr>
                           <?php
                              $sn=$sn+1;
                                                     }
         ...
         <!-- internship Start -->
         <div class="col-sm-12 mb-3">
            <div class="modal fade" id="studentViewModali" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                     ...
                     <div class="modal-body">
                        <img id="imagei" src="" alt="prizes" class="center" style="width:80%;height:80%;">           
                     </div>
                     <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     </div>
                     ...
                     <table id="zero_config5" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?= $student['dur'] ?></td>
                              <td><?= $student['rem'] ?></td>
                              <td align="center"><button type="button" id="ledonof" value="<?=$student['uid'];?>" class="btnimgi btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#studentViewModali">View</button></td>
                           </tr>
                           <?php
                              $sn=$sn+1;
                                                     }
         ...
         <!-- co-curricular Start -->
         <div class="col-sm-12 mb-3">
            <div class="modal fade" id="studentViewModalco" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">View Certificate</h5>
                     ...
                     <div class="modal-body">
                        <img id="imageco" src="" alt="Co-Curricular" class="center" style="width:80%;height:80%;">           
                     </div>
                     <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     </div>
                     ...
                     <table id="zero_config6" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?= $student['organiser'] ?></td>
                              <td><?= $student['prize'] ?></td>
                              <td align="center"><button type="button" id="ledonof" value="<?=$student['uid'];?>" class="btnimgco btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#studentViewModalco">View</button></td>
                           </tr>
                           <?php
                              $sn=$sn+1;
                                                     }
         ...
         <!-- Training Start -->
         <div class="col-sm-12 mb-3">
            <div class="modal fade" id="studentViewModalex" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">View Certificate</h5>
                     ...
                     <div class="modal-body">
                        <img id="imageex" src="" alt="Co-Curricular" class="center" style="width:80%;height:80%;">           
                     </div>
                     <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     </div>
                     ...
                     <table id="zero_config7" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?= $student['organiser'] ?></td>
                              <td><?= $student['prize'] ?></td>
                              <td align="center"><button type="button" id="ledonof" value="<?=$student['uid'];?>" class="btnimgex btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#studentViewModalex">View</button></td>
                           </tr>
                           <?php
                              $sn=$sn+1;
                                                     }
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <ul class="nav nav-tabs mb-3" role="tablist">
                     <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#sem1" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 1</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem2" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 2</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem3" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 3</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem4" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 4</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem5" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 5</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem6" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 6</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem7" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 7</b></span></a> </li>
                     <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sem8" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="ti-pencil-alt"></i><b> Semester 8</b></span></a> </li>
                  </ul>
                  <!--tab conetent -->
...
<?php
	...
	else
	{
		...
		swal.fire({
				icon: 'error',
                title: 'ID not Found',
                text: 'Note: Only you can view your Department students'
});
		 </script>
	<?php	
	}
