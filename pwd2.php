                    ...
                    <div class="card-body wizard-content">
                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#leave-management" role="tab">
                                        <span class="hidden-sm-up"></span>
                                        <span class="hidden-xs-down">
                                            <i class="fas fa-calendar-alt"></i><b> Leave Management</b>
                                        </span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#faculty-attendance" role="tab">
                                        <span class="hidden-sm-up"></span>
                                        <span class="hidden-xs-down">
                                            <i class="fas fa-user-check"></i><b> Faculty Attendance</b>
                                        </span>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content tabcontent-border">
                                ...
                                <div class="tab-pane p-20 active" id="leave-management" role="tabpanel">
                                    <p>1</p>
                                </div>

                                <!-- tab 2-->
                                <div class="tab-pane p-20 " id="faculty-attendance" role="tabpanel">
