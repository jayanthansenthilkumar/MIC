                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Mentees Profile Information</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card-body wizard-content">
                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#stdsum" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="bi bi-book"></i><b> Students Summary</b></span></a> </li>
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#couns" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="bi bi-book"></i><b> Reset</b></span></a> </li>

                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#smedi" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="bi bi-book"></i><b> HackerRank</b></span></a> </li>
						...
						<div class="mb-3">
								<label for="academic-year">Batch</label>
									<select class="form-control" name="academic-year1" id="batch" required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="myTablereset" class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th><b>S.No</b></th>
                                                                    <th><b>Student ID</b></th>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php if ($student['status'] == 1) : ?>
                                                                                    <button type="submit" value="<?= $student['sid']; ?>" class="resetBtn btn btn-info btn-md m-r-5">Reset</button>

                                                                                <?php endif; ?>
                                                                                <button type="submit" value="<?= $student['sid']; ?>" class="presetBtn btn btn-dark btn-md m-r-5" style="background-color: #522D5E; color: white;">Password</button>
